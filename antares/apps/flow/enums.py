...
class ActivityApplicationDefinitionScopeType(models.TextChoices):
    SAME = "Same", _(__name__ + 'ActivityApplicationDefinitionScopeType.' + 'SAME')
    BLANK = "Blank", _(__name__ + 'ActivityApplicationDefinitionScopeType.' + 'BLANK')
    DIALOG = 'Dialog', _(__name__ + 'ActivityApplicationDefinitionScopeType.' + 'DIALOG')


class ActivityType(models.TextChoices):
    ROUTE = "Route", _(__name__ + '.ActivityType.' + 'ROUTE')
    TASK = "Task", _(__name__ + '.ActivityType.' + 'TASK')
    NO_IMPLEMENTATION = "No Implementation", _(__name__ + '.ActivityType.' + 'NO_IMPLEMENTATION')
    SUBFLOW = "Sub Flow", _(__name__ + '.ActivityType.' + 'SUBFLOW')


class AssignmentStrategyType(models.TextChoices):
    DIRTY_RANDOM = "Dirty Random", _(__name__ + '.AssignmentStrategyType.' +
                         'DIRTY_RANDOM')
    RANDOM = "Random", _(__name__ + '.AssignmentStrategyType.' +
                         'RANDOM')
    PROPERTY = "Property", _(__name__ + '.AssignmentStrategyType.' +
                         'DIRTY_RANDOM')
    ACTIVITY = "Activity", _(__name__ + '.AssignmentStrategyType.' +
                         'ACTIVITY')
    WORKLOAD = "Workload", _(__name__ + '.AssignmentStrategyType.' +
                         'WORKLOAD')
    NONE = "None", _(__name__ + '.AssignmentStrategyType.' +
                         'NONE')


class DefinitionSiteType(models.TextChoices):
...
class FlowActivityStatusType(models.TextChoices):
...
class FlowBasicDataSubtype(models.TextChoices):
...
class FlowCaseSourceType(models.TextChoices):
    DOCUMENT = "Document", _(__name__ + '.FlowCaseSourceType.' + 'DOCUMENT')


class FlowCaseStatusType(models.TextChoices):
...
class FlowDefinitionStatusType(models.TextChoices):
    ...
    UNDER_REVISION = "UNDER_REVISION", _(__name__ + '.FlowDefinitionStatusType.' + 'UNDER_REVISION')
...
class FlowDocumentRelationshipType(models.TextChoices):
...
class FlowPriorityType(models.TextChoices):
...
class FormalParameterModeType(models.TextChoices):
...
class ParticipantType(models.TextChoices):
    ...
    ORGANIZATIONAL_UNIT = "ORGANIZATIONAL_UNIT", _(__name__ + '.ParticipantType.' + 'ORGANIZATIONAL_UNIT')
...
class TransitionType(models.TextChoices):
    ...
    DEFAULT_EXCEPTION = "DEFAULT_EXCEPTION", _(__name__ + '.TransitionType.' + 'DEFAULT_EXCEPTION')
...
class FlowDefinitionAccessLevelType(models.TextChoices):
...
class FlowActivityInstantiationType(models.TextChoices):
...
class TimeEstimationMethodType(models.TextChoices):
