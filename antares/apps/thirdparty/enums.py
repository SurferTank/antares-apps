...
class ThirdPartyRecordStatusType(models.TextChoices):
    OPEN = "Open", _(__name__ + '.ThirdPartyRecordStatusType.' + 'OPEN')
    PROCESSING = "Processing", _(__name__ + '.ThirdPartyRecordStatusType.' + 'PROCESSING')
...
class ThirdPartyDetailStatusType(models.TextChoices):
    OPEN = "Open", _(__name__ + '.ThirdPartyDetailStatusType.' + 'OPEN')
    PROCESSING = "Processing", _(__name__ + '.ThirdPartyDetailStatusType.' + 'PROCESSING')
...
class ThirdPartyChannelType(models.TextChoices):
