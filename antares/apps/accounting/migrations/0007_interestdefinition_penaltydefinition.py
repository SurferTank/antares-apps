# Generated by Django 2.2.9 on 2020-02-06 19:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rate', models.FloatField(default=0)),
                ('periodicity', enumfields.fields.EnumField(default='Month', enum=antares.apps.core.constants.TimeUnitType, max_length=10)),
                ('first_is_duedate', models.BooleanField(default=False)),
                ('use_calendar_periods', models.BooleanField(default=False)),
                ('creation_date', models.DateTimeField(blank=True, editable=False, null=True)),
                ('update_date', models.DateTimeField(blank=True, editable=False, null=True)),
                ('author', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
