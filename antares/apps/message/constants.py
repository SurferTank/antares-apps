...
class MessageType(EnumUtilsMixin, models.TextChoices):
    FORM_DEFINITION = "Form Definition", _(
        __name__ + '.MessageType.' + 'FORM_DEFINITION')
    FLOW_DEFINITION = "Flow Definition", _(
        __name__ + '.MessageType.' + 'FLOW_DEFINITION')
    CURRENT_ACCOUNT = "Current Account", _(
        __name__ + '.MessageType.' + 'CURRENT_ACCOUNT')
    FLOW_CASE = "Flow Case", _(__name__ + '.MessageType.' + 'FLOW_CASE')
    DOCUMENT = "Document", _(__name__ + '.MessageType.' + 'DOCUMENT')
    EXTERNAL_SYSTEM = "External System", _(
        __name__ + '.MessageType.' + 'EXTERNAL_SYSTEM')
