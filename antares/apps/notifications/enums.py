...
class NotificationDocumentStatusType(models.TextChoices):
    PENDING = "Pending", _(__name__ + '.NotificationDocumentStatusType.' + 'PENDING')
    PROCESSED = "Processed", _(__name__ + '.NotificationDocumentStatusType.' + 'PROCESSED')
    WITH_ERRORS = "With Errors", _(__name__ + '.NotificationDocumentStatusType.' + 'WITH_ERRORS')
    ON_HOLD = "On Hold", _(__name__ + '.NotificationDocumentStatusType.' + 'ON_HOLD')
    CANCELLED = "Cancelled", _(__name__ + '.NotificationDocumentStatusType.' + 'CANCELLED')
