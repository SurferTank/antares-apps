...
class ActionParameterDirectionType(models.TextChoices):
...
class ActionTargetModuleType(models.TextChoices):
...
class ActionType(models.TextChoices):
    ...
    POST_ACTION = "Postaction", _(__name__ + '.ActionType.' + 'POST_ACTION')
...
class HrnModuleType(models.TextChoices):
...
class LanguageType(models.TextChoices):
    ...
    DUTCH = "du", _(__name__ + '.LanguageType.' + 'DUTCH')
    GERMAN = "ge", _(__name__ + '.LanguageType.' + 'GERMAN')

class WeightUnitType(models.TextChoices):
...
class SystemModuleType(models.TextChoices):
