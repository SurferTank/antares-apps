            ...
            fields=[
                ...
                ('author',
                 models.ForeignKey(
                     editable=False,
                     help_text=
                     'antares.apps.core.models.i18n_string.author_help',
                     on_delete=django.db.models.deletion.PROTECT,
                     to=settings.AUTH_USER_MODEL,
            ...
            fields=[
                ...
                ('author',
                 models.ForeignKey(
                     editable=False,
                     help_text=
                     'antares.apps.core.models.stored_file.author_help',
                     on_delete=django.db.models.deletion.PROTECT,
                     to=settings.AUTH_USER_MODEL,
            ...
            fields=[
                ...
                ('author',
                 models.ForeignKey(
                     ...
                     to=settings.AUTH_USER_MODEL,
                     verbose_name=
                     'antares.apps.core.models.system_parameter.author')),
            ],
            options={
                'verbose_name':
            ...
            fields=[
                ...
                ('user',
                 models.ForeignKey(
                     blank=True,
                     help_text=
                     'antares.apps.core.models.user_parameter.user_help',
                     null=True,
                     on_delete=django.db.models.deletion.PROTECT,
                     to=settings.AUTH_USER_MODEL,
