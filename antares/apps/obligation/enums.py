...
class ObligationPeriodicityType(models.TextChoices):
    FIXED_DATE = "Fixed date", _(__name__ + '.ObligationPeriodicityType.' + 'FIXED_DATE')
    FIXED_PERIOD = "Fixed period", _(__name__ + '.ObligationPeriodicityType.' + 'FIXED_PERIOD')
    FREE_FORM = "Free form", _(__name__ + '.ObligationPeriodicityType.' + 'FREE_FORM')
