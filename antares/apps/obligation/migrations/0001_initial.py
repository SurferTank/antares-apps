        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_run', models.DateTimeField(
                    blank=True, editable=False, null=True)),
                ('obligation_type', enumfields.fields.EnumField(
                    enum=ObligationType, max_length=30)),
                ('origin', enumfields.fields.EnumField(
                    enum=ObligationOriginType, max_length=30)),
                ('periodicity_type', enumfields.fields.EnumField(
                    enum=ObligationPeriodicityType, max_length=30)),
                ('script_engine_type', enumfields.fields.EnumField(
                    enum=ScriptEngineType, max_length=30)),
                ('time_unit_type', enumfields.fields.EnumField(
                    enum=TimeUnitType, max_length=30)),
