...
class ItemStatusType(models.TextChoices):
...
class AddressType(models.TextChoices):
    ...
    ESPECIAL = "Especial", _(__name__ + '.AddressType.' + "SPECIAL")


class ClientArchetype(models.TextChoices):
    INDIVIDUAL = "Individual", _(__name__ + '.ClientArchetype.' + "INDIVIDUAL")
    CORPORATE = "Corporate", _(__name__ + '.ClientArchetype.' + "CORPORATE")


class ClientStatusType(models.TextChoices):
...
class TelephoneItemType(models.TextChoices):
...
class SocialNetworkItemType(models.TextChoices):
    SKYPE = "Skype", _(__name__ + '.SocialNetworkItemType.' + "SKYPE")


class ClientRelationType(models.TextChoices):
    ...
    GENERIC_WORKER = 'Worker', _(__name__ + '.ClientRelationType.' + 'WORKER') # this one has no executive relation

class ClientRelationPermissionType(models.TextChoices):
    ALL = "All", _(__name__ + '.ClientRelationPermissionType.' + "ALL")
    FILE = "File", _(__name__ + '.ClientRelationPermissionType.' + "FILE")


class ClientGenderType(models.TextChoices):
